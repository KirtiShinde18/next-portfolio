...
const tabs = ["Home", "Projects", "Contacts",];
          ...
          {tabs.map((tab) => (
            ...
            >
              {activeTab === tab && (
                <motion.div
                  layoutId="activeTab"
                  className="absolute inset-0 bg-gradient-to-r from-purple-300 to-indigo-300 px-3 py-2 rounded-lg"
      ...
      <div className="mt-6">
        ...
        {activeTab === "Projects" && (
          <div className="p-4 bg-white rounded-xl shadow">
            ...
            <p>He projects cha content aahe</p>
          </div>
        )}
        ...
        {activeTab === "Contact" && (
          <div className="p-4 bg-white rounded-xl shadow">
            ...
            <p>He contact cha content aahe</p>
          </div>
        )}
      </div>
